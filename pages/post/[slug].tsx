...
import { sanityClient, urlFor } from '../../components/sanity';
...
const Post = ({post}: Props) => {
  ...
  return (
   <>
    ...
    <h1 className=" font-titleFont font-medium text-[32px] text-primaryColor
            border-b-[1bx] border-b-cyan-800 mt-10 mb-3">{post.title}
          </h1>
          ...
          <div className="flex items-center gap-2">
            <img
             ...
             <p className="font-bodyFont text-base">
              ...
              {new Date(post.publishedAt).toLocaleDateString()} </p>
            </div>
                    <div className="mt-10">
            <PortableText
              
             projectId={process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || "9itrf0gm"} 
             content={post.body}
    ...
    <hr className="max-w-lg my-5 mx-auto border border-secondaryColor " />
        {
          submitted ?
           <div className="flex flex-col items-center gap-2 p-10 
           my-10 bg-bgColor text-white mx-auto ">
            <h1 className="text-2xl font-bold">Thank You for submitting your comment</h1>
            <p>once it has been approved, it will appear below!</p>
           </div> 
          : 
         <div>
          <p className='text-xs text-secondaryColor uppercase font-titleFont fomt-bold'>
                  Enjoy this Article
                  </p>
                    <h3 className="font-titleFont text-3xl font-bold">
                      ...
                      onSubmit={handleSubmit(onSubmit)}
                       className="mt-7 flex flex-col gap-6">
                        ...
                        <span className=" font-titleFont font-semibold text-base">
                          ...
                          className="text-base placeholder:text-sm border-b 
                          ...
                          {
                            errors.name && (
                              <p className="text-sm font-titleFont font-semibold text-red-500 
                              my-1 px-4">
                      ...
                      {session && 
                        ...
                        font-semibold tracking-wider uppercase py-2 rounded-sm hover:bg-secondaryColor 
                        duration-300"
